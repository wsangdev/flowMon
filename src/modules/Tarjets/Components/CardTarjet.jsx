...
export default function CardTarjet({color, text}) {
  return (
    <div className="mx-auto container flex justify-center py-16 px-4 animate-pulse">
      <div className="flex flex-col space-y-8 w-full px-16 max-w-xl">
        {/* card */}
        <div className={`bg-gradient-to-tl from-gray-900 to-blue-800 text-white h-56 w-96 p-6 rounded-xl shadow-md`}>
